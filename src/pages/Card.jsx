...
const Card = () => {
  return (
    <div className="flex justify-center items-center">
      <div className="grid grid-flow-row grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-5 p-2">
        {cards.map((card, i) => (
          <div key={card.name} className="animate-flip-down">
            <div className="relative inline-flex justify-center text-center uppercase font-bold m-3 transition duration-300 ease-in-out hover:scale-110">
              <img src={card.picture} className="max-w-[16em]" />
